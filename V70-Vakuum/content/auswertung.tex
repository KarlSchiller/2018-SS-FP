...
\input{tab/vol2.tex}
% TODO Nachgerechnet, alles war richtig... Was ein Trottel
...
% TODO Fehler Mittelwert der Zeiten neu berechnen
% Diese Mittelwertfehler sind bereits in python-Datei evak.py verarbeitet, aber nirgendwo sonst
% TODO Anderer Fehler bei Startwert, 1013 +- 5 mbar (Unsicherheit aufgrund Höhe, Wetter)
...
% TODO Ersten und letzten Wert mit berücksichtigen
...
% TODO Fehler der Mittelwerte der Zeiten neu berechnen
...
% TODO Fehler der Mittelwerte der Zeiten nachrechnen
...
% TODO Fehler der Mittelwerte nachrechnen
