...
Die gamma-Strahlung einer 137-Cs % Nachschauen, wie das 137 hochgestellt wird TODO
Quelle wird durch eine Blende kullimiert und trifft auf eine Probe in Form
eines Würfels.
% TODO
% gamma-Linie von 137 Cs
...
% TODO
% betastrahlung im Aluminium absorbiert
...
% TODO
% Abbildung mit den verschiedenen Strahlengängen durch den Würfel
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{content/wuerfelpos.pdf} % height=8.0cm
