...
\begin{align*}
    a &= \SI{1.632(2)e-05}{1\per\degree} \\
    b &= \SI{1.45(9)e-08}{1\per\raiseto{2}\degree} \\
    c &= \SI{-1.3(3)e-10}{1\per\raiseto{3}\degree} \\
    d &= \SI{-1.5(3)e-12}{1\per\raiseto{4}\degree} \\
    e &= \SI{-8.2(7)e-15}{1\per\raiseto{5}\degree}
\end{align*}
